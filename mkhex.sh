...
makecode -c mkc-digimakerbot.json -f size
cp ./built/mbdal-binary.hex ./assets/digimaker-bot-for-microbit-v1.hex
cp ./built/mbcodal-binary.hex ./assets/digimaker-bot-for-microbit-v2.hex
cd fwdedu
makecode -f size
cd ..
